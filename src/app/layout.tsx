...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    // Static card generated by scripts/gen-og-image.mjs (`npm run og:gen`),
    // standardized to match the ThyroidRehab share card. Resolves against
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "InsulinReset — 90-дневен протокол по д-р Benjamin Bikman",
      },
    ],
  },
  twitter: {
